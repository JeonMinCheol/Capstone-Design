 ...
 */
public class KafkaRowConverterImpl implements KafkaRowConverter<byte[], String> {
  /**
  ...
  @Override public RelDataType rowDataType(final String topicName) {
    ...
    fieldInfo.add("MSG_VALUE_BYTES", typeFactory.createSqlType(SqlTypeName.VARCHAR))
        .nullable(false);
   ...
   */
  @Override public Object[] toRow(final ConsumerRecord<byte[], String> message) {
